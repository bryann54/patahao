...
import '../../features/favourites/presentation/bloc/favourites_bloc.dart'
    as _i624;
import '../../features/properties/data/datasources/properties_remote_datasource.dart'
    as _i425;
...
import '../../features/properties/domain/repositories/properties_repository.dart'
    as _i269;
import '../../features/properties/domain/usecases/list_properties_usecase.dart'
    as _i886;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i174.GetIt> init({
    ...
    gh.factory<String>(
      () => registerModules.apiHost,
      instanceName: 'ApiHost',
    );
    gh.factory<String>(
    ...
    gh.lazySingleton<_i758.DioClient>(() => _i758.DioClient(
          ...
          gh<String>(instanceName: 'ApiHost'),
        ));
    ...
    gh.lazySingleton<_i425.PropertiesRemoteDatasource>(
        () => _i425.PropertiesRemoteDatasource(gh<_i546.ClientProvider>()));
    ...
    gh.lazySingleton<_i269.PropertiesRepository>(() =>
        _i375.PropertiesRepositoryImpl(gh<_i425.PropertiesRemoteDatasource>()));
    gh.lazySingleton<_i886.ListPropertiesUsecase>(
        () => _i886.ListPropertiesUsecase(gh<_i269.PropertiesRepository>()));
    gh.factory<_i708.AccountBloc>(
        () => _i708.AccountBloc(gh<_i993.ChangeLanguageUsecase>()));
    gh.factory<_i375.PropertiesBloc>(
        () => _i375.PropertiesBloc(gh<_i886.ListPropertiesUsecase>()));
    return this;
  }
}
